  ...
  Role.update(req.body, {
    ...
    .then(num => {
      if (num == 1) {
        ...
        res.send({
          message: `Cannot update Role with id=${id}. Maybe Position was not found or req.body is empty!`
        });
      }
    })
    .catch(err => {
  ...
  Role.destroy({
    ...
    .then(num => {
      if (num == 1) {
        ...
        res.send({
          message: `Cannot delete Role with id=${id}. Maybe Position was not found!`
        });
      }
    })
    .catch(err => {
